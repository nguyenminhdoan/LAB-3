...
export default function Contact() {
  ...
  const submitForm = (data) => {
    ...
    // You can add any logic here (e.g., make an API call)
    setValues({ ...values, ...data }); // Set form values on submit
  };
  ...
  return (
    <form onSubmit={handleSubmit(submitForm)}>
      ...
      {/* Submit Button */}
      <button type="submit" onClick={clickSubmit} className="submit">Submit</button>
    </form>
  );
}
