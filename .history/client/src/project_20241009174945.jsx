     ...
     <section id="works">
          ...
          <div className="worksImgs">
               ...
               <form id="ppj">
				...
				<label htmlFor="ownerFName"> *name: </label>
				<input type="text" id="ownerFName" name="ownerFName" required="required" autoFocus /> <br /> <br />
				
				<label htmlFor="myEmail"> *Email: </label>
				<input type="text" id="myEmailmyEmail" name="email" required="required" /> <br /> <br />
