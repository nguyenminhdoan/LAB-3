...
export default function Project() {
    ...
    */
    ...
    export default function Project() {
      ...
      const submitForm = () => {
        ...
        const project = {
          ...
          completion: values.email || undefined,
          description: values.email || undefined,
    ...
    <label htmlFor="completion">Completion Date:</label>
          <input
            {...register("completion", { required: "First name is required" })}
            value={values.completion} onChange={handleChange('firstname')}
          />
          {errors.firstname && <p>{errors.firstname.message}</p>}
          <br /><br />
